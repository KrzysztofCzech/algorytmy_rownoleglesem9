...
def getSlices(rank, numberOfCores, gridLegth):
...
def communicate(comm, rank, numberOfCores, gridLegth, matrix, upSlice, downSlice, begin, end):
    if rank % 2 == 0:
        if rank > 0:
...
def calculate(gridLegth, matrix, matrixTmp, upSlice, downSlice, begin, end):
...
def updateMatrix(comm, rank, numberOfCores, gridLegth, matrix, matrixTmp, upSlice, downSlice, begin, end):
    ...
    communicate(comm, rank, numberOfCores, gridLegth, matrix, upSlice, downSlice, begin, end)    
    matrix = calculate(gridLegth, matrix, matrixTmp, upSlice, downSlice, begin, end)
    return matrix
...
def main():
    ...
    iterations = 100
    sliceLenth = int(gridLegth / numberOfCores ) 
    ...
    for _ in range(numberOfTests):
        ...
        begin, end = getSlices(rank, numberOfCores, gridLegth)
